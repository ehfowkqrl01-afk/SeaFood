(function () {
  ...
  const restaurantDetails = {
    "통영생선회 동성로점": {
      ...
      menu: [
        { name: "모듬회 2인 세트", price: "₩45,000" },
        { name: "연어+광어 콤보", price: "₩38,000" },
        { name: "특선 사시미 (1인)", price: "₩28,000" },
        { name: "매운탕 추가", price: "₩8,000" }
      ],
    ...
    "수성못 해물왕": {
      ...
      menu: [
        { name: "해물탕 (中)", price: "₩45,000" },
        { name: "해물탕 (大)", price: "₩65,000" },
        { name: "아구찜 (中)", price: "₩55,000" },
        { name: "해물파전", price: "₩18,000" }
      ],
    ...
    "칠곡수산시장 회센터": {
      ...
      menu: [
        { name: "활어회 (100g)", price: "시세" },
        { name: "모듬회 (2~3인)", price: "₩35,000~" },
        { name: "조개구이 세트", price: "₩25,000" },
        { name: "매운탕", price: "₩10,000" }
      ],
    ...
    "조개마을 월성점": {
      ...
      menu: [
        { name: "조개구이 모듬 (2인)", price: "₩38,000" },
        { name: "조개구이 모듬 (3~4인)", price: "₩58,000" },
        { name: "해물파전", price: "₩16,000" },
        { name: "라면사리 추가", price: "₩2,000" }
      ],
    ...
    "바다밥상 반월당": {
      ...
      menu: [
        { name: "회덮밥 (점심 특선)", price: "₩12,000" },
        { name: "모듬 사시미 정식", price: "₩32,000" },
        { name: "연어 초밥 세트", price: "₩18,000" },
        { name: "우동 추가", price: "₩5,000" }
      ],
    ...
    "킹크랩 수성": {
      ...
      menu: [
        { name: "킹크랩 1kg (시세)", price: "₩85,000~" },
        { name: "대게찜 (2인)", price: "₩90,000" },
        { name: "해물 코스 A (2인)", price: "₩120,000" },
        { name: "랍스터 추가", price: "₩45,000" }
      ],
